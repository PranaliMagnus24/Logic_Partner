            ...
            <div class="card mt-3">
                ...
                <div class="card-body mt-3">
                    <form action="{{ route('store.quotation')}}" method="POST">
                        @csrf
                        <input type="hidden" name="enquiry_id" value="{{ request('enquiry_id') }}">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Project Location <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" name="project_location" class="form-control" value="{{ request('project_location') }}" readonly>
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Build Up Area <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Number of Floors <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Labor Cost <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Material Cost <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Equipment Cost <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Miscellaneous Expenses <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Total Cost <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Start Date <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Completion Date <span class="text-danger">*</span></label>
                            <div class="col-md-8">
