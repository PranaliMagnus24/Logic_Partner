...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    if (dataTablePermissions) {
        dt_permission = new DataTable(dataTablePermissions, {
            ajax: {
                url: '/permission/list', // Ensure this URL matches your route
                method: 'GET',
                dataSrc: 'data' // The key in the JSON response that contains the array of data
            },
            columns: [
                { data: null, render: function() { return ''; } }, // Placeholder for control column
                    ...
                    render: function(data) {
                        return `
                            <div class="d-flex align-items-center">
                               <button class="btn btn-icon me-1 edit-permission" data-id="${data.id}" data-name="${data.name}" data-bs-toggle="modal" data-bs-target="#editPermissionModal">
